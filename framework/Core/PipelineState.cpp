...
void PipelineState::setPipelineLayout(PipelineLayout &newPipelineLayout) {
    if (pipelineLayout) {
...
void PipelineState::setRenderPass(const RenderPass &newRenderPass) {
    if (renderPass) {
...
void PipelineState::setSpecializationConstant(uint32_t constantId, const std::vector<uint8_t> &data) {
...
void PipelineState::setVertexInputState(const VertexInputState &newVertexInputState) {
...
void PipelineState::setInputAssemblyState(const InputAssemblyState &newInputAssemblyState) {
...
void PipelineState::setRasterizationState(const RasterizationState &newRasterizationState) {
...
void PipelineState::setViewportState(const ViewportState &newViewportState) {
...
void PipelineState::setMultisampleState(const MultisampleState &newMultisampleState) {
...
void PipelineState::setDepthStencilState(const DepthStencilState &newDepthStencilState) {
...
void PipelineState::setColorBlendState(const ColorBlendState &newColorBlendState) {
...
void PipelineState::setSubpassIndex(uint32_t newSubpassIndex) {
