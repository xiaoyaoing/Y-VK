...
//        if (vkCreatePipelineLayout(_device->getHandle(), &pipelineLayoutCreateInfo, nullptr, &pipelineLayout) !=
//            VK_SUCCESS)
...
//                                    _swapChain->getExtent().width / (float)_swapChain->getExtent().height, 0.1f,
//                                    10.0f);
//        ubo.proj[1][1] *= -1;
...
//        meshes.reserve(1);
//        meshes.push_back(
//            std::make_shared<Mesh>("/Users/yjp/nju/大三下/graphics/vulkan学习/vulkan/resources/viking_room.obj"));
//        meshes[0]->createBuffer(allocator);
//    }
//
//    void initVk()
//    {
//        // todo queue family ind#ex
//        //   createInstance();
...
//        uint32_t imageIndex;
//        auto result = vkAcquireNextImageKHR(_device->getHandle(), _swapChain->getHandle(), UINT64_MAX,
//                                            imageAvailableSemaphores[curFrameCount],
//                                            VK_NULL_HANDLE,
//                                            &imageIndex);
