...
// Shader code: uniform buffer definition

layout(std140, set = 0, binding = 3) uniform ClipMapUniforms {
    int u_clipmapLevel;
    int u_clipmapResolution;
    int u_clipmapResolutionWithBorder;
    float dummy1;// ¶ÔÆëÌî³ä

    vec3 u_regionMin;
    float dummy2;// ¶ÔÆëÌî³ä
    vec3 u_regionMax;
    float dummy3;// ¶ÔÆëÌî³ä
    vec3 u_prevRegionMin;
    float dummy4;// ¶ÔÆëÌî³ä
    vec3 u_prevRegionMax;
    float dummy5;// ¶ÔÆëÌî³ä
    float u_downsampleTransitionRegionSize;
    float u_maxExtent;
    float u_voxelSize;
    float dummy6;// ¶ÔÆëÌî³ä
};
