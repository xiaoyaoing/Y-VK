...
//     sponza->loadFromFile(FileUtils::getResourcePath("sponza/sponza.gltf"), glTFLoadingFlags);
// //
...
//     descriptorLayout->addBinding(VK_SHADER_STAGE_FRAGMENT_BIT, 2, 1, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 0);
