...
//
//     AssimpLoaderImpl(Device& device, const std::string& path, const SceneLoadingConfig& config);
//     ~AssimpLoaderImpl();
//
...
// }
//
// void AssimpLoaderImpl::loadCameras(const tinygltf::Model& model) {
...
//     }
// }
// int  AssimpLoaderImpl::requestTexture(int tex) {
//     if(tex ==-1)
//         return -1;
...
//     return texIndexRemap[tex];
// }
// void AssimpLoaderImpl::process(const tinygltf::Model& model) {
//
...
//
//
// Transform AssimpLoaderImpl::getTransform(const tinygltf::Node& node) {
//     Transform transform;
...
// }
//
// void AssimpLoaderImpl::processNode(const tinygltf::Node& node, const tinygltf::Model& model) {
//     if (node.mesh > -1) {
...
// }
//
// void AssimpLoaderImpl::loadFromFile(const std::string& path) {
//
//     Timer timer;
//     timer.start();
//
...
// }
//
// void AssimpLoaderImpl::loadMaterials(tinygltf::Model& gltfModel) {
//
...
// }
//
// AssimpLoaderImpl::~AssimpLoaderImpl() {
//     // for (auto node : nodes)
//     //     delete node;
// }
//
// void AssimpLoaderImpl::loadImages(const std::filesystem::path& modelPath, const tinygltf::Model& gltfModel) {
...
//
//
// const Texture* AssimpLoaderImpl::getTexture(uint32_t index) const {
...
// }
//
// std::unique_ptr<Scene> AssimpLoader::LoadSceneFromGLTFFile(Device& device, const std::string& path, const SceneLoadingConfig& config) {
//     auto model                = std::make_unique<AssimpLoaderImpl>(device, path, config);
...
// }
//
// AssimpLoaderImpl::AssimpLoaderImpl(Device& device, const std::string& path, const SceneLoadingConfig& config) : device(device), config(config) {
//     loadFromFile(path);
// }
//
