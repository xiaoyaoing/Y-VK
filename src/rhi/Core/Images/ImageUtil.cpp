...
std::tuple<VkAccessFlags, VkAccessFlags, VkPipelineStageFlags2, VkPipelineStageFlags2, VkImageLayout, VkImageLayout>
ImageUtil::getVkTransition(VulkanLayout oldLayout, VulkanLayout newLayout) {
    ...
    switch (newLayout) {
        case VulkanLayout::COLOR_ATTACHMENT:
            dstAccessMask = VK_ACCESS_SHADER_READ_BIT | VK_ACCESS_SHADER_WRITE_BIT | VK_ACCESS_COLOR_ATTACHMENT_READ_BIT | VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT;
            dstStage      = VK_PIPELINE_STAGE_VERTEX_SHADER_BIT | VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT | VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT;
            break;
        case VulkanLayout::READ_WRITE:
    ...
    return std::make_tuple(srcAccessMask, dstAccessMask, srcStage, dstStage, getVkImageLayout(oldLayout), getVkImageLayout(newLayout));
}
