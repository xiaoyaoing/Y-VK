...
RTSceneEntryImpl::~RTSceneEntryImpl() {
    for (auto& blas : blases) {
        vkDestroyAccelerationStructureKHR(device.getHandle(), blas.accel, nullptr);
    }
...
std::unique_ptr<RTSceneEntry> RTSceneBuilder::build(Device& device, Scene& scene) {
