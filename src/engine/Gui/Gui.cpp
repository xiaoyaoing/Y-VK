...
void applyEditorStyle() {
    ...
    colors[ImGuiCol_Text] = ImVec4(0.92f, 0.93f, 0.91f, 1.00f);
    colors[ImGuiCol_TextDisabled] = ImVec4(0.51f, 0.56f, 0.58f, 1.00f);
    colors[ImGuiCol_WindowBg] = ImVec4(0.08f, 0.10f, 0.12f, 1.00f);
    colors[ImGuiCol_ChildBg] = ImVec4(0.10f, 0.12f, 0.14f, 0.92f);
    colors[ImGuiCol_PopupBg] = ImVec4(0.11f, 0.13f, 0.16f, 0.98f);
    colors[ImGuiCol_Border] = ImVec4(0.20f, 0.24f, 0.27f, 0.85f);
    colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[ImGuiCol_FrameBg] = ImVec4(0.13f, 0.16f, 0.18f, 1.00f);
    colors[ImGuiCol_FrameBgHovered] = ImVec4(0.17f, 0.22f, 0.24f, 1.00f);
    colors[ImGuiCol_FrameBgActive] = ImVec4(0.21f, 0.27f, 0.29f, 1.00f);
    colors[ImGuiCol_TitleBg] = ImVec4(0.09f, 0.11f, 0.13f, 1.00f);
    colors[ImGuiCol_TitleBgActive] = ImVec4(0.11f, 0.14f, 0.17f, 1.00f);
    colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.09f, 0.11f, 0.13f, 0.85f);
    colors[ImGuiCol_MenuBarBg] = ImVec4(0.10f, 0.12f, 0.14f, 1.00f);
    colors[ImGuiCol_ScrollbarBg] = ImVec4(0.09f, 0.11f, 0.13f, 1.00f);
    colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.25f, 0.32f, 0.35f, 1.00f);
    colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.31f, 0.40f, 0.44f, 1.00f);
    colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.36f, 0.47f, 0.51f, 1.00f);
    colors[ImGuiCol_CheckMark] = ImVec4(0.41f, 0.77f, 0.68f, 1.00f);
    colors[ImGuiCol_SliderGrab] = ImVec4(0.37f, 0.70f, 0.80f, 1.00f);
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.48f, 0.81f, 0.90f, 1.00f);
    colors[ImGuiCol_Button] = ImVec4(0.18f, 0.34f, 0.39f, 1.00f);
    colors[ImGuiCol_ButtonHovered] = ImVec4(0.23f, 0.43f, 0.48f, 1.00f);
    colors[ImGuiCol_ButtonActive] = ImVec4(0.28f, 0.53f, 0.58f, 1.00f);
    colors[ImGuiCol_Header] = ImVec4(0.15f, 0.21f, 0.24f, 1.00f);
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.19f, 0.29f, 0.32f, 1.00f);
    colors[ImGuiCol_HeaderActive] = ImVec4(0.23f, 0.36f, 0.39f, 1.00f);
    colors[ImGuiCol_Separator] = ImVec4(0.21f, 0.24f, 0.28f, 1.00f);
    colors[ImGuiCol_SeparatorHovered] = ImVec4(0.33f, 0.49f, 0.55f, 1.00f);
    colors[ImGuiCol_SeparatorActive] = ImVec4(0.41f, 0.61f, 0.67f, 1.00f);
    colors[ImGuiCol_ResizeGrip] = ImVec4(0.29f, 0.42f, 0.46f, 0.40f);
    colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.37f, 0.57f, 0.63f, 0.80f);
    colors[ImGuiCol_ResizeGripActive] = ImVec4(0.45f, 0.69f, 0.76f, 0.95f);
    colors[ImGuiCol_Tab] = ImVec4(0.12f, 0.15f, 0.18f, 1.00f);
    colors[ImGuiCol_TabHovered] = ImVec4(0.18f, 0.28f, 0.32f, 1.00f);
    colors[ImGuiCol_TabActive] = ImVec4(0.20f, 0.34f, 0.38f, 1.00f);
    colors[ImGuiCol_TabUnfocused] = ImVec4(0.10f, 0.12f, 0.14f, 1.00f);
    colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.15f, 0.22f, 0.25f, 1.00f);
    colors[ImGuiCol_DockingPreview] = ImVec4(0.31f, 0.63f, 0.71f, 0.70f);
    colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.07f, 0.08f, 0.10f, 1.00f);
    colors[ImGuiCol_TableHeaderBg] = ImVec4(0.13f, 0.17f, 0.19f, 1.00f);
    colors[ImGuiCol_TableBorderStrong] = ImVec4(0.24f, 0.28f, 0.31f, 1.00f);
    colors[ImGuiCol_TableBorderLight] = ImVec4(0.16f, 0.20f, 0.22f, 1.00f);
    colors[ImGuiCol_TableRowBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[ImGuiCol_TableRowBgAlt] = ImVec4(0.12f, 0.14f, 0.16f, 0.55f);
    colors[ImGuiCol_TextSelectedBg] = ImVec4(0.22f, 0.50f, 0.58f, 0.45f);
    colors[ImGuiCol_NavHighlight] = ImVec4(0.43f, 0.79f, 0.88f, 1.00f);
    colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.04f, 0.05f, 0.06f, 0.72f);
}
} // namespace
